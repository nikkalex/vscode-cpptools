...
// Original file: vscode/src/vs/editor/common/viewLayout/viewLayout.ts

import { Event, Emitter } from '../event';
import { Disposable, IDisposable } from '../lifecycle';
import { IScrollPosition, ScrollEvent, Scrollable, ScrollbarVisibility, INewScrollPosition } from '../scrollable';
import { ConfigurationChangedEvent, EditorOption } from 'vs/editor/common/config/editorOptions';
import { IConfiguration, ScrollType } from '../editorCommon';
import { LinesLayout, IEditorWhitespace, IWhitespaceChangeAccessor } from './linesLayout';
