...
// Original file: vscode/src/vs/editor/browser/view/viewUserInputEvents.ts

import { IKeyboardEvent } from '../keyboardEvent';
import { MouseTarget } from 'vs/editor/browser/controller/mouseTarget';
import { IEditorMouseEvent, IMouseTarget, IPartialEditorMouseEvent, MouseTargetType } from '../editorBrowser';
