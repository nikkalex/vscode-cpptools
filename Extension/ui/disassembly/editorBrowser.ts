...
// Original file: vscode/src/vs/editor/browser/editorBrowser.ts

import { IKeyboardEvent } from './keyboardEvent';
import { IMouseEvent, IMouseWheelEvent } from './mouseEvent';
import { IDisposable } from './lifecycle';
import { ConfigurationChangedEvent, EditorLayoutInfo, IComputedEditorOptions, EditorOption, FindComputedEditorOptionValueById, IEditorOptions, IDiffEditorOptions } from 'vs/editor/common/config/editorOptions';
...
import { IIdentifiedSingleEditOperation, IModelDecoration, IModelDeltaDecoration, ITextModel, ICursorStateComputer, IWordAtPosition } from './model';
