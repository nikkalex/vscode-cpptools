...
// Original file: vscode/src/vs/editor/common/viewModel/splitLinesCollection.ts

import * as arrays from 'vs/base/common/arrays';
import { WrappingIndent } from 'vs/editor/common/config/editorOptions';
import { Position } from '../core/position';
import { IRange, Range } from '../core/range';
import { IActiveIndentGuideInfo, IModelDecoration, IModelDeltaDecoration, ITextModel } from '../model';
...
import { ICoordinatesConverter, ILineBreaksComputer, LineBreakData, ViewLineData } from '../viewModel/viewModel';
...
export interface IViewModelLinesCollection extends IDisposable {
	...
	onModelFlushed(): void;
	onModelLinesDeleted(fromLineNumber: number, toLineNumber: number): viewEvents.ViewLinesDeletedEvent | null;
	onModelLinesInserted(fromLineNumber: number, toLineNumber: number, lineBreaks: (LineBreakData | null)[]): viewEvents.ViewLinesInsertedEvent | null;
	onModelLineChanged(lineNumber: number, lineBreakData: LineBreakData | null): [boolean, viewEvents.ViewLinesChangedEvent | null, viewEvents.ViewLinesInsertedEvent | null, viewEvents.ViewLinesDeletedEvent | null];
...
export class SplitLinesCollection implements IViewModelLinesCollection {
	...
	public onModelLinesDeleted(fromLineNumber: number, toLineNumber: number): viewEvents.ViewLinesDeletedEvent | null {
	...
	public onModelLinesInserted(fromLineNumber: number, _toLineNumber: number, lineBreaks: (LineBreakData | null)[]): viewEvents.ViewLinesInsertedEvent | null {
	...
	public onModelLineChanged(lineNumber: number, lineBreakData: LineBreakData | null): [boolean, viewEvents.ViewLinesChangedEvent | null, viewEvents.ViewLinesInsertedEvent | null, viewEvents.ViewLinesDeletedEvent | null] {
...
class VisibleIdentitySplitLine implements ISplitLine {
	...
	public getViewLineData(model: ISimpleModel, modelLineNumber: number, _outputLineIndex: number): ViewLineData {
		let lineContent = model.getLineContent(modelLineNumber);
...
export class IdentityLinesCollection implements IViewModelLinesCollection {
	...
	public onModelLinesInserted(fromLineNumber: number, toLineNumber: number, lineBreaks: (LineBreakData | null)[]): viewEvents.ViewLinesInsertedEvent | null {
