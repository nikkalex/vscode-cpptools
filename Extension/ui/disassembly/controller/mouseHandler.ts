...
// Origina file: vscode/src/vs/editor/browser/controller/mouseHandler.ts
...
import { HitTestContext, IViewZoneData, MouseTarget, MouseTargetFactory, PointerHandlerLastRenderData } from './mouseTarget';
import { IMouseTarget, MouseTargetType } from '../editorBrowser';
import { ClientCoordinates, EditorMouseEvent, EditorMouseEventFactory, GlobalEditorMouseMoveMonitor, createEditorPagePosition } from '../editorDom';
